...
function logEvent(eventType) {
    //czas
    var today = new Date();
    var time = today.getFullYear().toString()+(("0" + today.getMonth()).slice(-2))+(("0" + today.getDate()).slice(-2))+today.getHours()+ today.getMinutes()+ today.getSeconds()+Math.round(today.getMilliseconds()/10);
    //tworzenie pliku
